...
const RestoCard = ( props ) => {
    const {resData} = props;
    const {name,areaName,costForTwo,cuisines,cloudinaryImageId,locality} = resData?.info;
    return (
        <div className="restocard-wrapper">
            ...
            <h3 className="restocardfont1">Address: {areaName}, {locality}</h3>
...
const resList = [
    ...
    },
    {
      "info": {
        ...
        "availability": {
          "nextCloseTime": "2024-01-15 00:59:00",
          "opened": true
        },
        "badges": {
    ...
    },
    {
      "info": {
        ...
        "availability": {
          "nextCloseTime": "2024-01-14 23:55:00",
          "opened": true
        },
        "badges": {
    ...
    return (
        <div className="body">
            ...
            <div className="res-container">
                {
                    resList.map((res) => (<RestoCard key={res.info.id} resData={res}/>))
